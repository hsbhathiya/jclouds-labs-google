...
public class ObjectaclListTest extends BaseGoogleCloudStorageParseTest<ListObjectAccessControls> {
   ...
   private ObjectAccessControls item_1 = ObjectAccessControls
            .builder()
            ...
            .entityId("00b4903a97adfde729f0650133a7379693099d8d85d6b1b18255ca70bf89e31d").role(Role.OWNER)
   ...
   public ListObjectAccessControls expected() {
      return ListObjectAccessControls.builder().kind(Kind.objectAccessControls).items(ImmutableSet.of(item_1)).build();
   }
