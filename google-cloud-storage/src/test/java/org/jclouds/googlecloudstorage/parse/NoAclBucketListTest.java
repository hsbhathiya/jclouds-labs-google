 ...
 */
public class NoAclBucketListTest extends BaseGoogleCloudStorageParseTest<ListPage<Buckets>> {

   private Buckets item_1 = Buckets.builder().id("bhashbucket")
   ...
   public ListPage<Buckets> expected() {
      return ListPage.<Buckets> builder().kind(Kind.buckets).nextPageToken("bhashbucket").addItem(item_1).build();
   }
