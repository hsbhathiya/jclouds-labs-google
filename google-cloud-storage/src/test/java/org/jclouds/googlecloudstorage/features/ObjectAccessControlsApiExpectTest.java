...
public class ObjectAccessControlsApiExpectTest extends BaseGoogleCloudStorageApiExpectTest {
   ...
   public static final HttpResponse GET_OBJECTACL_RESPONSE = HttpResponse.builder().statusCode(200)
            .payload(staticPayloadFromResource("/objectacl_get.json")).build();

   public static final HttpResponse CREATE_OBJECTACL_RESPONSE = HttpResponse.builder().statusCode(200)
            .payload(staticPayloadFromResource("/objectacl_insert_response.json")).build();

   public static final HttpRequest LIST_OBJECTACL_REQUEST = HttpRequest.builder().method("GET")
            .endpoint("https://www.googleapis.com/storage/v1/b/jcloudtestbucket/o/foo.txt/acl")
            .addHeader("Accept", "application/json").addHeader("Authorization", "Bearer " + TOKEN).build();

   public static final HttpRequest LIST_OBJECTACL_REQUEST_WITHOPTIONS = HttpRequest.builder().method("GET")
            .endpoint("https://www.googleapis.com/storage/v1/b/jcloudtestbucket/o/foo.txt/acl")
            .addQueryParam("generation", "100").addHeader("Accept", "application/json")
            .addHeader("Authorization", "Bearer " + TOKEN).build();

   public static final HttpResponse LIST_OBJECTACL_RESPONSE = HttpResponse.builder().statusCode(200)
   ...
   public void testInsertObjectaclWithOptionsResponseIs2xx() throws Exception {
      ...
      ObjectAccessControlsTemplate template = new ObjectAccessControlsTemplate().entity(
               "user-00b4903a97adfde729f0650133a7379693099d8d85d6b1b18255ca70bf89e31d").role(Role.OWNER);
   ...
   public void testDeleteObjectaclWithNoOptionsResponseIs2xx() throws Exception {
      ...
      ObjectAccessControlsApi api = requestsSendResponses(requestForScopes(STORAGE_FULLCONTROL_SCOPE), TOKEN_RESPONSE,
               delete, deleteResponse).getObjectAccessControlsApi();

      assertEquals(api.deleteObjectAccessControls(EXPECTED_TEST_BUCKET, EXPECTED_TEST_OBJECT, "allUsers"),
               deleteResponse);
   }

   public void testDeleteObjectaclWithOptionsResponseIs2xx() throws Exception {
      HttpRequest delete = HttpRequest.builder().method("DELETE")
               .endpoint("https://www.googleapis.com/storage/v1/b/jcloudtestbucket/o/foo.txt/acl/allUsers")
               .addQueryParam("generation", "100").addHeader("Accept", "application/json")
               .addHeader("Authorization", "Bearer " + TOKEN).build();
      ...
      assertEquals(api.deleteObjectAccessControls(EXPECTED_TEST_BUCKET, EXPECTED_TEST_OBJECT, "allUsers",
               Long.valueOf(100)), deleteResponse);
   }
   ...
   public void testUpdateObjectaclWithNoOptionsResponseIs2xx() throws Exception {
      HttpRequest update = HttpRequest
               ...
               .addHeader("Accept", "application/json")
               .addHeader("Authorization", "Bearer " + TOKEN)
               .payload(payloadFromResourceWithContentType("/objectacl_update_response.json",
                        MediaType.APPLICATION_JSON)).build();
      ...
      ObjectAccessControls options = ObjectAccessControls.builder()
               .selfLink(URI.create("https://www.googleapis.com/storage/v1/b/jcloudtestbucket/o/foo.txt/acl/allUsers"))
               .bucket("jcloudtestbucket").object("foo.txt").entity("allUsers").role(Role.OWNER)
               .etag("CIix/dmj/rwCEAQ=").build();

      assertEquals(api.updateObjectAccessControls(EXPECTED_TEST_BUCKET, EXPECTED_TEST_OBJECT, "allUsers", options),
   ...
   public void testUpdateObjectaclWithOptionsResponseIs2xx() throws Exception {
      ...
      assertEquals(
               api.updateObjectAccessControls(EXPECTED_TEST_BUCKET, EXPECTED_TEST_OBJECT, "allUsers", options,
   ...
   public void testPatchObjectaclWithNoOptionsResponseIs2xx() throws Exception {
      ...
      ObjectAccessControlsApi api = requestsSendResponses(requestForScopes(STORAGE_FULLCONTROL_SCOPE), TOKEN_RESPONSE,
               patchRequest , updateResponse).getObjectAccessControlsApi();
      ...
      assertEquals(api.patchObjectAccessControls(EXPECTED_TEST_BUCKET, EXPECTED_TEST_OBJECT, "allUsers", options),
               new ObjectaclUpdateTest().expected());
   }
   ...
   public void testPatchObjectaclWithOptionsResponseIs2xx() throws Exception {
      ...
      assertEquals(
               api.patchObjectAccessControls(EXPECTED_TEST_BUCKET, EXPECTED_TEST_OBJECT, "allUsers", options,
                        Long.valueOf(100)), new ObjectaclUpdateTest().expected());
   }
