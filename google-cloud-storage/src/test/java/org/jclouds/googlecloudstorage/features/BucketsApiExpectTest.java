...
public class BucketsApiExpectTest extends BaseGoogleCloudStorageApiExpectTest {
   ...
   public void testGetBucketWithOptionsResponseIs2xx() throws Exception {
      ...
      GetBucketsOptions options = new GetBucketsOptions().ifMetagenerationNotMatch(Long.valueOf(100)).projection(
               Projection.FULL);
   ...
   public void testCreateBucketWithNoOptionsResponseIs2xx() throws Exception {
      ...
      BucketsTemplate template = new BucketsTemplate().name("bhashbucket");
   ...
   public void testUpdateBucketWithNoOptionsResponseIs2xx() throws Exception {
      ...
      BucketsTemplate template = new BucketsTemplate().name(EXPECTED_TEST_BUCKET).addAcl(bucketacl);
   ...
   public void testUpdateBucketWithOptionsResponseIs2xx() throws Exception {
      ...
      BucketAccessControls bucketacl = BucketAccessControls.builder().bucket(EXPECTED_TEST_BUCKET)
               .entity("allAuthenticatedUsers").role(Role.OWNER).build();
      UpdateBucketsOptions options = new UpdateBucketsOptions().projection(Projection.NO_ACL).ifMetagenerationNotMatch(
               Long.valueOf(100));
      BucketsTemplate template = new BucketsTemplate().name(EXPECTED_TEST_BUCKET).addAcl(bucketacl);
   ...
   public void testPatchBucketWithNoOptionsResponseIs2xx() throws Exception {
      ...
      BucketsApi api = requestsSendResponses(requestForScopes(STORAGE_FULLCONTROL_SCOPE), TOKEN_RESPONSE, patchRequest,
