...
import org.jclouds.googlecloudstorage.parse.NoAclBucketGetTest;
...
@Test(groups = "unit")
public class BucketsApiExpectTest extends BaseGoogleCloudStorageApiExpectTest {
   ...
   public static final HttpResponse LIST_BUCKET_RESPONSE = HttpResponse.builder().statusCode(200)
   ...
   public void testGetBucketWithNoOptionsResponseIs2xx() throws Exception {
      ...
      BucketsApi api = requestsSendResponses(requestForScopes(STORAGE_READONLY_SCOPE), TOKEN_RESPONSE,
               GET_BUCKET_REQUEST, GET_BUCKET_RESPONSE).getBucketsApi();

      assertEquals(api.getBuckets(EXPECTED_TEST_BUCKET), new NoAclBucketGetTest().expected());
   }
   ...
   public void testListBucketWithNoOptionsResponseIs2xx() throws Exception {
      ...
      BucketsApi api = requestsSendResponses(requestForScopes(STORAGE_FULLCONTROL_SCOPE), TOKEN_RESPONSE,
   ...
   /*
    * // Test insertBucketAccessControls public void testInsertBucketaclResponseIs2xx() throws Exception { HttpRequest
    * insertRequest = HttpRequest .builder() .method("POST")
    * .endpoint("https://www.googleapis.com/storage/v1/b/jcloudtestbucket/acl") .addHeader("Accept", "application/json")
    ...
    * 
    * BucketAccessControls options = BucketAccessControls .builder() .id("jcloudtestbucket/allAuthenticatedUsers")
    * .selfLink( URI.create("https://content.googleapis.com/storage/v1/b/jcloudtestbucket/acl/allAuthenticatedUsers"))
    ...
    * }
    * 
    * // Test deleteBucketAccessControls public void testDeleteBucketacleResponseIs2xx() throws Exception { HttpRequest
    * delete = HttpRequest.builder().method("DELETE")
    ...
    * 
    * public void testDeleteBucketaclResponseIs4xx() throws Exception { HttpRequest delete =
    ...
    * 
    * // Test updateBucketAccessControls public void testUpdateBucketaclResponseIs2xx() throws Exception { HttpRequest
    * update = HttpRequest .builder() .method("PUT")
    * .endpoint("https://www.googleapis.com/storage/v1/b/jcloudtestbucket/acl/allUsers") .addHeader("Accept",
    * "application/json") .addHeader("Authorization", "Bearer " + TOKEN)
    ...
    * 
    * assertEquals(api.updateBucketAccessControls(EXPECTED_TEST_BUCKET, "allUsers", options), new
    * BucketaclUpdateTest().expected()); }
    * 
    * // Test updateBucketAccessControls public void testPatchBucketaclResponseIs2xx() throws Exception { HttpRequest
    * patchRequest = HttpRequest .builder() .method("PATCH")
    * .endpoint("https://www.googleapis.com/storage/v1/b/jcloudtestbucket/acl/allUsers") .addHeader("Accept",
    * "application/json") .addHeader("Authorization", "Bearer " + TOKEN)
    * .payload(payloadFromResourceWithContentType("/bucketacl_update_response.json",
    * MediaType.APPLICATION_JSON)).build();
    ...
    * .bucket(EXPECTED_TEST_BUCKET).entity("allUsers").role(Role.OWNER).etag("CAg=").build();
    * 
    * assertEquals(api.patchBucketAccessControls(EXPECTED_TEST_BUCKET, "allUsers", options), new
    * BucketaclUpdateTest().expected()); }
    */
