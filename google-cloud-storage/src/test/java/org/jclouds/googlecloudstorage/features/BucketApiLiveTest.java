...
public class BucketApiLiveTest extends BaseGoogleCloudStorageApiLiveTest {
   ...
   private static final String LOG_BUCKET_NAME = "jcloudlogbucket" + (int) (Math.random() * 10000);
   ...
   public void testDeleteBucket() {
      HttpResponse response = api().deleteBucket(BUCKET_NAME);
      HttpResponse response2 = api().deleteBucket(LOG_BUCKET_NAME);
   ...
   public void testDeleteBucketWithOptions() {
      ...
      HttpResponse response = api().deleteBucket(BUCKET_NAME_WITHOPTIONS, options);
