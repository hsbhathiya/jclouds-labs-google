 ...
 * @see <a href=""/>
 */
public class UpdateBucketsOptions extends BaseHttpRequestOptions {

   public UpdateBucketsOptions ifMetagenerationMatch(Long ifMetagenerationMatch) {
      this.queryParameters.put("ifMetagenerationMatch", checkNotNull(ifMetagenerationMatch, "ifMetagenerationMatch")
               + "");
      return this;
   }

   public UpdateBucketsOptions ifMetagenerationNotMatch(Long ifMetagenerationNotMatch) {
      this.queryParameters.put("ifMetagenerationNotMatch",
               checkNotNull(ifMetagenerationNotMatch, "ifMetagenerationNotMatch") + "");
      return this;
   }

   public UpdateBucketsOptions projection(Projection projection) {
      this.queryParameters.put("projection", checkNotNull(projection, "projection").toString());
      return this;
   }
   
   public UpdateBucketsOptions predefinedAcl(PredefinedAcl predefinedAcl) {
   ...
   public static class Builder {
      ...
      public UpdateBucketsOptions ifMetagenerationMatch(Long ifMetagenerationMatch) {
         return new UpdateBucketsOptions().ifMetagenerationMatch(ifMetagenerationMatch);
      }

      public UpdateBucketsOptions ifMetagenerationNotMatch(Long ifMetagenerationNotMatch) {
         return new UpdateBucketsOptions().ifMetagenerationNotMatch(ifMetagenerationNotMatch);
      }

      public UpdateBucketsOptions projection(Projection projection) {
         return new UpdateBucketsOptions().projection(projection);
      }
      

      public UpdateBucketsOptions predefinedAcl(PredefinedAcl predefinedAcl) {
         return new UpdateBucketsOptions().predefinedAcl(predefinedAcl);
      }
