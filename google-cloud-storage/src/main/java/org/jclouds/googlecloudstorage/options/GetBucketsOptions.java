 ...
 * @see <a href=""/>
 */
public class GetBucketsOptions extends BaseHttpRequestOptions {

   public GetBucketsOptions ifMetagenerationMatch(Long ifMetagenerationMatch) {
      this.queryParameters.put("ifMetagenerationMatch", checkNotNull(ifMetagenerationMatch, "ifMetagenerationMatch")
               + "");
      return this;
   }

   public GetBucketsOptions ifMetagenerationNotMatch(Long ifMetagenerationNotMatch) {
      this.queryParameters.put("ifMetagenerationNotMatch",
               checkNotNull(ifMetagenerationNotMatch, "ifMetagenerationNotMatch") + "");
      return this;
   }

   public GetBucketsOptions projection(Projection projection) {
   ...
   public static class Builder {
      ...
      public GetBucketsOptions ifMetagenerationMatch(Long ifMetagenerationMatch) {
         return new GetBucketsOptions().ifMetagenerationMatch(ifMetagenerationMatch);
      }

      public GetBucketsOptions ifMetagenerationNotMatch(Long ifMetagenerationNotMatch) {
         return new GetBucketsOptions().ifMetagenerationNotMatch(ifMetagenerationNotMatch);
      }

      public GetBucketsOptions projection(Projection projection) {
         return new GetBucketsOptions().projection(projection);
      }
