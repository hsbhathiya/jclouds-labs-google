...
public class BucketsTemplate {
   ...
   public BucketsTemplate addDefaultObjectAccessControls(DefaultObjectAccessControls oac) {
   ...
   public BucketsTemplate defaultObjectAccessControls(Set<DefaultObjectAccessControls> defaultObjectAcl) {
      if (this.defaultObjectAccessControls == null) {
         this.defaultObjectAccessControls = Sets.newLinkedHashSet();
      }
