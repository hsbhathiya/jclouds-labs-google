...
/**
 * All data in Google Cloud Storage belongs inside a project. A project consists of a set of users, a set of APIs, and
 * billing, authentication, and monitoring settings for those APIs. User can have one project or multiple projects.
 * <p/>
 * 
