...
public class Bucket extends Resource {
   ...
   protected Bucket(Kind kind, String id, URI selfLink, String name, String etag, Date creationTimestamp,
      ...
      this.defaultObjectAcl = checkNotNull(defaultObjectAcl, "defaultObjectAcl");
      this.owner = checkNotNull(owner, "Owner");
      this.location = checkNotNull(location, "location");
      this.website = checkNotNull(website, "website");
      this.logging = checkNotNull(logging, "logging");
      this.versioning = checkNotNull(versioning, "versioning");
   ...
   protected Objects.ToStringHelper string() {
      return super.string().omitNullValues().add("name", name).add("creationTimestamp", creationTimestamp)
   ...
   public static final class Builder extends Resource.Builder<Builder> {
      ...
      public Bucket build() {
         return new Bucket(super.kind, super.id, super.selfLink, name, super.etag, creationTimestamp, metageneration,
   ...
   public static class Owner {
      ...
      protected Objects.ToStringHelper string() {
         return toStringHelper(this).add("entiy", entity).add("entityId", entityId);
      }
