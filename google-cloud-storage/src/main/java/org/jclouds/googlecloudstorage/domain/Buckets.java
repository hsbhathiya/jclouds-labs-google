...
/**
 * The Buckets represents a bucket in Google Cloud Storage There is a single global namespace shared by all buckets
 * 
...
public class Buckets extends Resource {
   ...
   protected final Set<DefaultObjectAccessControls> defaultObjectAcl;
