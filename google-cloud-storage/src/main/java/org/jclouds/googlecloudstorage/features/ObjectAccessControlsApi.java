...
public interface ObjectAccessControlsApi {
    ...
    * 
    * @return an ObjectAccessControls resource
    */
    ...
    *           Name of the bucket of that ACL is related
    * 
    * @return If successful, this method returns a ObjectAccessControls resource
    */
   ...
   @Fallback(NullOnNotFoundOr404.class)
   @Nullable
   HttpResponse deleteObjectAccessControls(@PathParam("bucket") String bucketName,
            @PathParam("object") String objectName, @PathParam("entity") String entity);
