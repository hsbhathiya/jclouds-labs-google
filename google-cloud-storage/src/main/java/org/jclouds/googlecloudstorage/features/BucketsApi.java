...
public interface BucketsApi {
    ...
    *           Name of the bucket
    * 
    * @return a {@link Buckets} resource
    */
    ...
    * 
    * @return If successful, this method returns a {@link Buckets} resource in the response body
    */
   ...
   Buckets createBuckets(@QueryParam("project") String projectId,
            @PayloadParam("template") BucketsTemplate bucketTemplate);
    ...
    * 
    * @param bucketTemplate
    *           In the request body, supply a {@link Buckets} resource
    * @param options
   ...
   @OAuthScopes(STORAGE_FULLCONTROL_SCOPE)
   @MapBinder(BucketsBinder.class)
   Buckets createBuckets(@QueryParam("project") String projectNumber,
            @PayloadParam("template") BucketsTemplate bucketTemplate, InsertBucketsOptions options);
    ...
    * 
    * @return a {@link ListPage<Buckets>}
    */
